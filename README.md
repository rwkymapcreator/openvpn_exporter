...
For pre built binaries, please take a look at the [github releases](https://github.com/rwkymapcreator/openvpn_exporter/releases)
...
```shell script
git clone https://github.com/rwkymapcreator/openvpn_exporter.git
cd openvpn_exporter
